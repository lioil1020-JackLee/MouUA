...
# Default scan rate (milliseconds) - for tags
MODBUS_DEFAULT_SCAN_RATE = 1000

# Default baud rate for serial connections
MODBUS_DEFAULT_BAUD_RATE = 9600

# Default timeout (seconds) - for connections
MODBUS_DEFAULT_TIMEOUT = 3

# Default device timing settings (matching device dialog defaults)
...
# Default device data access settings (matching device dialog defaults)
MODBUS_DEFAULT_DATA_ACCESS = {
    "zero_based": "Disable",  # 0 = Disable, 1 = Enable
    "zero_based_bit": "Enable",  # 1 = Enable, 0 = Disable
    "bit_writes": "Disable",  # 0 = Disable, 1 = Enable
    "func_06": "Enable",  # 1 = Enable, 0 = Disable
    "func_05": "Enable",  # 1 = Enable, 0 = Disable
}

# Default device block sizes (matching device dialog defaults)
...
# Default Modbus worker settings
MODBUS_DEFAULT_MAX_REGS = 120  # Maximum registers per read operation
MODBUS_DEFAULT_OUT_COILS = 2000
MODBUS_DEFAULT_IN_COILS = 2000

# Default tag settings (matching tag dialog defaults)
MODBUS_DEFAULT_TAG = {
    "data_type": "Word",
    "access": "Read/Write",
    "scan_rate": "10",
...
# Default tag scaling settings (matching tag dialog defaults)
...
# Default channel communication settings (matching channel dialog defaults)
...
# Default device encoding settings (matching device dialog defaults)
MODBUS_DEFAULT_ENCODING = {
    "byte_order": "Enable",  # 1 = Enable (Modbus Big-Endian), 0 = Disable (Intel Little-Endian)
    "word_order": "Enable",  # 1 = First Word Low, 0 = First Word High
    "dword_order": "Enable",  # 1 = First DWord Low, 0 = First DWord High
    "bit_order": "Disable",  # 0 = LSB (normal), 1 = MSB (Modicon)
    "treat_longs_as_decimals": "Disable",  # 0 = False, 1 = True
}
